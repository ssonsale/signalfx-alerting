resource "signalfx_detector" "cic-test-k8s_container_restarts" {
...
resource "signalfx_detector" "cic-test-k8s_container_cpu" {
...
resource "signalfx_detector" "cic-test-k8s_container_memory" {
